...
export default function TaxReport() {
  ...
  const availableTaxYears = Array.from({ length: 6 }, (_, i) =>
  ...
  const exportTaxReport = () => {
    ...
    try {
      ...
      const header =
        "Date,Type,Symbol,Amount,Price,Cost Basis,Proceeds,Gain/Loss,Holding Period (Days),Term\n";
      ...
      {isLoading ? (
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-medium ${taxSummary.shortTermGains >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-medium ${taxSummary.longTermGains >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-medium ${taxSummary.totalGains >= 0 ? "text-green-600" : "text-red-600"}`}
                      >
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        ${taxSummary.costBasis.toFixed(2)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Proceeds:</span>
                      <span className="font-medium">
                        ${taxSummary.proceeds.toFixed(2)}
                      </span>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="bg-muted p-3 rounded-md text-sm text-muted-foreground">
                      <p>
                        This is only an estimate. Please consult with a tax
            ...
            <Card>
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {Object.entries(taxSummary.byAsset).map(
                      ([symbol, data]) => (
                        <TableRow key={symbol}>
                          ...
                          <TableCell
                            className={`text-right ${data.totalGains >= 0 ? "text-green-600" : "text-red-600"}`}
                          >
            ...
            <Card>
              <CardHeader className="flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Detailed list of all relevant transactions for{" "}
                    {taxSummary.taxYear}
                  </CardDescription>
                </div>
                <Button
                    ...
                    <TableBody>
                      {transactions.map((tx) => (
                        <TableRow key={tx.id}>
                          ...
                          <TableCell
                            className={`text-right ${tx.gainLoss >= 0 ? "text-green-600" : "text-red-600"}`}
                          >
        ...
        <div className="flex flex-col items-center justify-center py-12">
          <p className="text-center text-muted-foreground mb-4">
            No tax data available. Please check your transaction history or try
            different settings.
          </p>
